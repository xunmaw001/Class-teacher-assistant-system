            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">住宿管理</li>
                        <li class="breadcrumb-item active">编辑住宿</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
        ...
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("zhusu/" + urlParam, "POST", data, (res) => {
                if(res.code == 0)
                {
                    window.sessionStorage.removeItem('addzhusu');
    ...
    // 获取当前详情
    function getDetails() {
        var addzhusu = window.sessionStorage.getItem("addzhusu");
        if (addzhusu != null && addzhusu != "" && addzhusu != "null") {
            window.sessionStorage.removeItem('addzhusu');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("zhusu/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
