            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑家长</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>学生姓名</label>
                                        <input id="yname" name="yname" class="form-control"
                                               placeholder="学生姓名" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生手机号</label>
                                        <input id="yphone" name="yphone" class="form-control"
                                               placeholder="学生手机号" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生身份证号</label>
                                        <input id="yidNumber" name="yidNumber" class="form-control"
                                               placeholder="学生身份证号" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生性别</label>
                                        <input id="ysexValue" name="ysexValue" class="form-control"
                                               placeholder="学生性别" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生照片</label>
                                        <img id="ymyPhotoImg" src="" width="100" height="100">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生民族</label>
                                        <input id="ynation" name="ynation" class="form-control"
                                               placeholder="学生民族" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生政治面貌</label>
                                        <input id="ypoliticsValue" name="ypoliticsValue" class="form-control"
                                               placeholder="学生政治面貌" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生籍贯</label>
                                        <input id="ybirthplace" name="ybirthplace" class="form-control"
                                               placeholder="学生籍贯" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>学生是否毕业</label>
                                        <input id="yyonghuValue" name="yyonghuValue" class="form-control"
                                               placeholder="学生是否毕业" readonly>
                                    </div>
                            <!-- 当前表的字段 -->
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#yonghuId") !=null){
            ...
            httpJson("jiazhang/" + urlParam, "POST", data, (res) => {
                if(res.code == 0)
                {
                    window.sessionStorage.removeItem('addjiazhang');
    ...
    // 查询列表
        ...
        function yonghuSelectOne(id) {
            http("yonghu/info/"+id, "GET", {}, (res) => {
                if(res.code == 0){
                ruleForm = res.data;
                ruleForm.ymyPhoto=ruleForm.myPhoto;
                yonghuShowImg();
                yonghuDataBind();
            }
        });
    ...
    // 获取当前详情
    function getDetails() {
        var addjiazhang = window.sessionStorage.getItem("addjiazhang");
        if (addjiazhang != null && addjiazhang != "" && addjiazhang != "null") {
            window.sessionStorage.removeItem('addjiazhang');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("jiazhang/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function yonghuDataBind(){
        ...
        $("#yonghuId").val(ruleForm.id);
                    ...
                    debugger
        $("#yusername").val(ruleForm.username);
        $("#ypassword").val(ruleForm.password);
        $("#yname").val(ruleForm.name);
        $("#yphone").val(ruleForm.phone);
        $("#yidNumber").val(ruleForm.idNumber);
        $("#ysexValue").val(ruleForm.sexValue);
        $("#ynation").val(ruleForm.nation);
        $("#ypoliticsValue").val(ruleForm.politicsValue);
        $("#ybirthplace").val(ruleForm.birthplace);
        $("#yyonghuValue").val(ruleForm.yonghuValue);
    }
    ...
    function yonghuShowImg() {
        $("#ymyPhotoImg").attr("src",ruleForm.ymyPhoto);
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') != '管理员') {
            // $('. aaaaa').attr('style', 'pointer-events: none;');
            $('.bbbbbb').remove();
