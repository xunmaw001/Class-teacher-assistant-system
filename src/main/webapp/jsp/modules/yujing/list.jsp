    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">学业预警管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学业预警列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">学业预警列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                 
                                            <label>
                                                预警类型
                                                <select name="yujingTypesSelectSearch" id="yujingTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function search() {
        ...
        if(sexTypesSelectSearchInput != null){
            ...
            //预警类型
        var yujingTypesSelectSearchInput = document.getElementById("yujingTypesSelectSearch");
        if(yujingTypesSelectSearchInput != null){
            var yujingTypesIndex = yujingTypesSelectSearchInput.selectedIndex;
            if( yujingTypesIndex  != 0){
                searchForm.yujingTypes= document.getElementById("yujingTypesSelectSearch").options[yujingTypesIndex].value;
            }
        }
                    getDataList();
    }
    ...
    function getDataList() {
        http("yujing/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            yujingTypes: searchForm.yujingTypes,
    ...
    function setDataRow(item, number) {
        ...
        //预警类型
        var yujingTypesCell = document.createElement('td');
        yujingTypesCell.innerHTML = item.yujingValue;
        row.appendChild(yujingTypesCell);


            //预警内容
        var yujingContentCell = document.createElement('td');
        //如果图文详情包含图片
        if (item.yujingContent && item.yujingContent.indexOf('img') != -1) {
            //暂时只考虑图片+文字 和 文字+图片的情况
            var beginIndex = item.yujingContent.indexOf('<img');
            var endIndex = item.yujingContent.indexOf('>');
                yujingContentCell.innerHTML = item.yujingContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
        } else {
            if (item.yujingContent != null && item.yujingContent != "" && item.yujingContent.length >= 11) {
                    yujingContentCell.innerHTML = item.yujingContent.substring(0, 10) + "...";
            } else {
                    yujingContentCell.innerHTML = item.yujingContent;
            }
        }
        row.appendChild(yujingContentCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("yujing/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addyujing", "addyujing");
        window.location.href = "add-or-update.jsp"
    }
    ...
    //填充本表搜索下拉框
        ...
        function yujingTypesSelectSearch() {
            var yujingTypesSelectSearch = document.getElementById('yujingTypesSelectSearch');
            if(yujingTypesSelectSearch != null) {
                yujingTypesSelectSearch.add(new Option('',''));
                if (yujingTypesOptions != null && yujingTypesOptions.length > 0){
                    for (var i = 0; i < yujingTypesOptions.length; i++) {
                            yujingTypesSelectSearch.add(new Option(yujingTypesOptions[i].indexName,yujingTypesOptions[i].codeIndex));
                    }
                }
            }
        }
