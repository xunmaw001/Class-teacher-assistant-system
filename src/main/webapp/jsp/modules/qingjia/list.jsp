                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                            ...
                                            <label>
                                                请假天数
                                                <input type="text" id="qingjiaNumberStartSearch" onchange="qingjiaNumberChickValue(this)"   class="form-control " placeholder="开始" aria-controls="tableId">
                                            </label>
                                                -
                                            <label>
                                                <input type="text" id="qingjiaNumberEndSearch" onchange="qingjiaNumberChickValue(this)"     class="form-control" placeholder="结束" aria-controls="tableId">
                                            </label>
                                 
                                            <label>
                                                请假状态
                                                <select name="qingjiaTypesSelectSearch" id="qingjiaTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function search() {
        ...
        //请假开始时间
        var ondaySearchInput = $('#ondaySearch');
        if( ondaySearchInput != null){
            if (ondaySearchInput.val() != null && ondaySearchInput.val() != '') {
                searchForm.onday = $('#ondaySearch').val();
            }
        }
     
        //请假结束时间
        var downdaySearchInput = $('#downdaySearch');
        if( downdaySearchInput != null){
            if (downdaySearchInput.val() != null && downdaySearchInput.val() != '') {
                searchForm.downday = $('#downdaySearch').val();
            }
        }
     
            //请假天数
        var qingjiaNumberStartSearchInput = $('#qingjiaNumberStartSearch');
        if(qingjiaNumberStartSearchInput != null){
            var qingjiaNumberStartSearchValue = qingjiaNumberStartSearchInput.val();
            if( qingjiaNumberStartSearchValue  != 0){
                searchForm.qingjiaNumberStart = qingjiaNumberStartSearchValue;
            }
        }
        var qingjiaNumberEndSearchInput = $('#qingjiaNumberEndSearch');
        if(qingjiaNumberEndSearchInput != null){
            var qingjiaNumberEndSearchValue = qingjiaNumberEndSearchInput.val();
            if( qingjiaNumberEndSearchValue  != 0){
                searchForm.qingjiaNumberEnd = qingjiaNumberEndSearchValue;
            }
        }
    ...
    function getDataList() {
        http("qingjia/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            onday: searchForm.onday,
            downday: searchForm.downday,
            qingjiaNumberStart: searchForm.qingjiaNumberStart,
            qingjiaNumberEnd: searchForm.qingjiaNumberEnd,
    ...
    //填充本表搜索下拉框
        ...
        function qingjiaTypesSelectSearch() {
            ...
            if(qingjiaTypesSelectSearch != null) {
                qingjiaTypesSelectSearch.add(new Option('',''));
